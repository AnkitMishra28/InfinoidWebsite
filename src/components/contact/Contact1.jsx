    ...
    <div className="relative h-[80vh] flex items-center justify-center text-white">
      ...
      <div className="relative text-center leading-1">
        ...
        <button 
          ...
          className="bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-500 hover:to-blue-400 text-white font-semibold py-6 px-8 rounded-4xl transition-all duration-300 shadow-lg hover:shadow-xl shadow-purple-900/50 hover:shadow-blue-900/40"
        >
          Let's Connect 
        </button>
      </div>
